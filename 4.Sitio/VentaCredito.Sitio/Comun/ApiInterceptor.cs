...
{
    public class ApiInterceptor : RealProxy, IDisposable
    {

        private object _subject;
        private string _Modulo;

        public ApiInterceptor(object subject, string Modulo)
        ...
        public override IMessage Invoke(IMessage msg)
        {
            ...
            if (ContextoSitio.Current != null)
                usuario = ContextoSitio.Current.Usuario;
            else
                usuario = "NoUsuario";
            ...
            if (owner != null)
            {
                ...
                ApiExcepcionesHandler.EjecutarAccion(() =>
                {
                    ...
                    {
                        Util.AuditarExcepcion(Retual.Exception);
            ...
            else
            {
                ...
                throw new FaultException<ControllerException>(new ControllerException("FW", ETipoErrorFramework.EX_ERROR_EN_INTERCEPTOR.ToString(), MensajesFramework.CargarMensaje(ETipoErrorFramework.EX_ERROR_EN_INTERCEPTOR)));
            }
        }
    ...
    public class ApiExcepcionesHandler
    {
        ...
        public static void EjecutarAccion(Action Accion, string Modulo, IMessage msg, string usuario)
        {
            ...
            catch (System.ServiceModel.FaultException<ControllerException> exController)
            {
                throw new Exception(exController.Message);
            }
            catch (Exception Ex)
            {
                AuditoriaTrace.EscribirAuditoriaParametros(ETipoAuditoria.Error, "WebApi-" + Ex.Message, Modulo, Ex, usuario, msg);
