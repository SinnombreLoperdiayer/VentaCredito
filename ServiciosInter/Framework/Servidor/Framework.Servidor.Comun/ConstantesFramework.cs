...
namespace Framework.Servidor.Comun
{
  ...
  public class ConstantesFramework
  {
    ...
    /// <summary>
    /// Cache de Movimientos Caja Controller
    /// </summary>
    public const string CACHE_MOVIMIENTO_CAJA_CONTROLLER = "CacheMovimientoCajaController";

    /// <summary>
    /// Cache de Movimientos Caja Controller
    /// </summary>
    public const string CACHE_MOVIMIENTO_CAJA_API = "CacheMovimientoCajaApi";
