...
namespace Framework.Servidor.Comun.EncryptQueryStrings
{
  public static class Encryption64
  {
    ...
    public static string ObtenerLlaveEncripcion()
    {
      return ConfigurationManager.AppSettings["CryptoKeyReportes"];
    }
  }
}