...
namespace Framework.Cliente.Utilidades
{
  public class ConversorNumLetras
  {
    ...
    public ConversorNumLetras(Boolean ConvertirDecimales, String MascaraSalidaDecimal, String SeparadorDecimalSalida, Boolean LetraCapital)
    {
    ...
    {
      return ConversorNumLetras.ToCardinal(Numero, CultureInfo.CurrentCulture);
    }
