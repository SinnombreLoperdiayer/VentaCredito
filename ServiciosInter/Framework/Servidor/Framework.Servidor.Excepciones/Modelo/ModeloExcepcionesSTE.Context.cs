...
namespace Framework.Servidor.Excepciones.Modelo
{
    ...
    public partial class ModeloExcepciones : DbContext
    {
        public ModeloExcepciones(string ConnectionString)
    	...
    	/// <summary>
          ...
          /// </summary>
    		...
    		/// <summary>
    		/// Retorna la lista de InstrumentacionModulo_AUD que cumpla con las expresiones de filtrado y ordenamiento
          /// </summary>
    		/// <param name="filtro">Diccionario a través del cual se filtra la lista</param>
        	/// <param name="campoOrdenamiento">Campo por el cual se va a realizar el ordenamiento</param>
    		/// <param name="totalRegistros">Retorna el total de de registros que satisfacen la consulta sin paginar</param>
        	...
        	/// <param name="esAscendente">Indica si es ascendente el ordenamiento</param>
        	/// <returns></returns>
    			public IEnumerable<InstrumentacionModulo_AUD> ConsultarContainsInstrumentacionModulo_AUD(IDictionary<string, string> filtro, string campoOrdenamiento, out int totalRegistros, int indicePagina = 0, int registrosPorPagina = 20, bool esAscendente = true)
    		{
    			Expression<Func<InstrumentacionModulo_AUD, bool>> expresionFiltrado = ObtenerExpresionContains<InstrumentacionModulo_AUD>(filtro);
    			return ConsultarInstrumentacionModulo_AUD(expresionFiltrado, campoOrdenamiento, out totalRegistros, indicePagina, registrosPorPagina, esAscendente);
    		}
          ...
          /// </summary>
        	...
        	/// <param name="esAscendente">Indica si es ascendente el ordenamiento</param>
        	/// <returns></returns>
    		public IEnumerable<InstrumentacionModulo_AUD> ConsultarEqualsInstrumentacionModulo_AUD(IDictionary<string, string> filtro, string campoOrdenamiento, out int totalRegistros, int indicePagina = 0, int registrosPorPagina = 20, bool esAscendente = true)
    		{
    				Expression<Func<InstrumentacionModulo_AUD, bool>> expresionFiltrado = ObtenerExpresionEquals<InstrumentacionModulo_AUD>(filtro);
    				return ConsultarInstrumentacionModulo_AUD(expresionFiltrado, campoOrdenamiento, out totalRegistros, indicePagina, registrosPorPagina, esAscendente);
    		}
          ...
          /// </summary>
        	...
        	/// <param name="esAscendente">Indica si es ascendente el ordenamiento</param>
        	/// <returns></returns>
    		public IEnumerable<InstrumentacionModulo_AUD> ConsultarInstrumentacionModulo_AUD(IDictionary<string, string> filtros, Dictionary<LambdaExpression, OperadorLogico> where, string campoOrdenamiento, out int totalRegistros, int indicePagina = 0, int registrosPorPagina = 20, bool esAscendente = true)
    		{
    				Expression<Func<InstrumentacionModulo_AUD, bool>> expresionFiltrado = ObtenerFiltro<InstrumentacionModulo_AUD>(filtros,where);
    				return ConsultarInstrumentacionModulo_AUD(expresionFiltrado, campoOrdenamiento, out totalRegistros, indicePagina, registrosPorPagina, esAscendente);
    		}
          ...
          /// </summary>
        	...
        	/// <param name="esAscendente">Indica si es ascendente el ordenamiento</param>
        	/// <returns></returns>
    		public IEnumerable<InstrumentacionModulo_AUD> ConsultarInstrumentacionModulo_AUD(Expression<Func<InstrumentacionModulo_AUD, bool>> expresionFiltrado, string campoOrdenamiento, out int totalRegistros, int indicePagina = 0, int registrosPorPagina = 20, bool esAscendente = true)
    		{
    			// Verificando parámetros para la consulta
    			if (indicePagina < 0)
    				throw new ArgumentException("Número de Página inválida");
    			...
    			//Create associated IObjectSet and perform query			
    			var objectSet = ((IObjectContextAdapter)this).ObjectContext.CreateObjectSet<InstrumentacionModulo_AUD>();
    		...
    		/// <summary>
          /// Retorna la lista de InstrumentacionModulo_AUD que cumpla con la expresión de ordenamiento
          /// </summary>
        	/// <param name="campoOrdenamiento">Campo por el cual se va a realizar el ordenamiento</param>
    		/// <param name="totalRegistros">Retorna el total de registros que genera la consulta sin paginar</param>
        	/// <param name="indicePagina">Índice de página a retornar</param>
        	...
        	/// <param name="esAscendente">Indica si es ascendente el ordenamiento</param>
        	/// <returns></returns>
    		public IEnumerable<InstrumentacionModulo_AUD> ConsultarInstrumentacionModulo_AUD(string campoOrdenamiento, out int totalRegistros, int indicePagina = 0, int registrosPorPagina = 20, bool esAscendente = true)
    		{
    			// Verificando parámetros para la consulta
    			if (indicePagina < 0)
    				throw new ArgumentException("Página inválida");
    		...
    		/// <summary>
    		/// Retorna la lista de Instrumentacion_AUD que cumpla con las expresiones de filtrado y ordenamiento
          /// </summary>
    		/// <param name="filtro">Diccionario a través del cual se filtra la lista</param>
        	/// <param name="campoOrdenamiento">Campo por el cual se va a realizar el ordenamiento</param>
    		/// <param name="totalRegistros">Retorna el total de de registros que satisfacen la consulta sin paginar</param>
        	...
        	/// <param name="esAscendente">Indica si es ascendente el ordenamiento</param>
        	/// <returns></returns>
    			public IEnumerable<Instrumentacion_AUD> ConsultarContainsInstrumentacion_AUD(IDictionary<string, string> filtro, string campoOrdenamiento, out int totalRegistros, int indicePagina = 0, int registrosPorPagina = 20, bool esAscendente = true)
    		{
    			Expression<Func<Instrumentacion_AUD, bool>> expresionFiltrado = ObtenerExpresionContains<Instrumentacion_AUD>(filtro);
    			return ConsultarInstrumentacion_AUD(expresionFiltrado, campoOrdenamiento, out totalRegistros, indicePagina, registrosPorPagina, esAscendente);
    		}
          ...
          /// </summary>
        	...
        	/// <param name="esAscendente">Indica si es ascendente el ordenamiento</param>
        	/// <returns></returns>
    		public IEnumerable<Instrumentacion_AUD> ConsultarEqualsInstrumentacion_AUD(IDictionary<string, string> filtro, string campoOrdenamiento, out int totalRegistros, int indicePagina = 0, int registrosPorPagina = 20, bool esAscendente = true)
    		{
    				Expression<Func<Instrumentacion_AUD, bool>> expresionFiltrado = ObtenerExpresionEquals<Instrumentacion_AUD>(filtro);
    				return ConsultarInstrumentacion_AUD(expresionFiltrado, campoOrdenamiento, out totalRegistros, indicePagina, registrosPorPagina, esAscendente);
    		}
          ...
          /// </summary>
        	...
        	/// <param name="esAscendente">Indica si es ascendente el ordenamiento</param>
        	/// <returns></returns>
    		public IEnumerable<Instrumentacion_AUD> ConsultarInstrumentacion_AUD(IDictionary<string, string> filtros, Dictionary<LambdaExpression, OperadorLogico> where, string campoOrdenamiento, out int totalRegistros, int indicePagina = 0, int registrosPorPagina = 20, bool esAscendente = true)
    		{
    				Expression<Func<Instrumentacion_AUD, bool>> expresionFiltrado = ObtenerFiltro<Instrumentacion_AUD>(filtros,where);
    				return ConsultarInstrumentacion_AUD(expresionFiltrado, campoOrdenamiento, out totalRegistros, indicePagina, registrosPorPagina, esAscendente);
    		}
          ...
          /// </summary>
        	...
        	/// <param name="esAscendente">Indica si es ascendente el ordenamiento</param>
        	/// <returns></returns>
    		public IEnumerable<Instrumentacion_AUD> ConsultarInstrumentacion_AUD(Expression<Func<Instrumentacion_AUD, bool>> expresionFiltrado, string campoOrdenamiento, out int totalRegistros, int indicePagina = 0, int registrosPorPagina = 20, bool esAscendente = true)
    		{
    			// Verificando parámetros para la consulta
    			if (indicePagina < 0)
    				throw new ArgumentException("Número de Página inválida");
    			...
    			//Create associated IObjectSet and perform query			
    			var objectSet = ((IObjectContextAdapter)this).ObjectContext.CreateObjectSet<Instrumentacion_AUD>();
    		...
    		/// <summary>
          /// Retorna la lista de Instrumentacion_AUD que cumpla con la expresión de ordenamiento
          /// </summary>
        	/// <param name="campoOrdenamiento">Campo por el cual se va a realizar el ordenamiento</param>
    		/// <param name="totalRegistros">Retorna el total de registros que genera la consulta sin paginar</param>
        	/// <param name="indicePagina">Índice de página a retornar</param>
        	...
        	/// <param name="esAscendente">Indica si es ascendente el ordenamiento</param>
        	/// <returns></returns>
    		public IEnumerable<Instrumentacion_AUD> ConsultarInstrumentacion_AUD(string campoOrdenamiento, out int totalRegistros, int indicePagina = 0, int registrosPorPagina = 20, bool esAscendente = true)
    		{
    			// Verificando parámetros para la consulta
    			if (indicePagina < 0)
    				throw new ArgumentException("Página inválida");
        ...
        public DbSet<InstrumentacionModulo_AUD> InstrumentacionModulo_AUD { get; set; }
        public DbSet<Instrumentacion_AUD> Instrumentacion_AUD { get; set; }
    	#endregion
    }
		/// <summary>
