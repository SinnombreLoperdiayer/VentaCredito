...
namespace CO.Servidor.Dominio.Comun.AdmEstadosConsolidado.Datos.Modelo
{
    ...
    public partial class ModeloEstadosConsolidados : DbContext
    {
        public ModeloEstadosConsolidados(string ConnectionString)
        ...
        private Expression<Func<TLinqEntity, bool>> ArmarExpresionFiltrado<TLinqEntity>(IDictionary<string, string> filtros, string tipoFiltro)
        {
          ...
          return null;
    		    ...
    		    #region Consultas
    	/// <summary>
    		/// Retorna la lista de EstadoConsolidado_OPU que cumpla con las expresiones de filtrado y ordenamiento
          /// </summary>
        	...
        	/// <returns></returns>
    			public IEnumerable<EstadoConsolidado_OPU> ConsultarContainsEstadoConsolidado_OPU(IDictionary<string, string> filtro, string campoOrdenamiento, out int totalRegistros, int indicePagina = 0, int registrosPorPagina = 20, bool esAscendente = true)
    		{
    			Expression<Func<EstadoConsolidado_OPU, bool>> expresionFiltrado = ObtenerExpresionContains<EstadoConsolidado_OPU>(filtro);
    			return ConsultarEstadoConsolidado_OPU(expresionFiltrado, campoOrdenamiento, out totalRegistros, indicePagina, registrosPorPagina, esAscendente);
    		}
          ...
          /// </summary>
        	...
        	/// <param name="esAscendente">Indica si es ascendente el ordenamiento</param>
        	/// <returns></returns>
    		public IEnumerable<EstadoConsolidado_OPU> ConsultarEqualsEstadoConsolidado_OPU(IDictionary<string, string> filtro, string campoOrdenamiento, out int totalRegistros, int indicePagina = 0, int registrosPorPagina = 20, bool esAscendente = true)
    		{
    				Expression<Func<EstadoConsolidado_OPU, bool>> expresionFiltrado = ObtenerExpresionEquals<EstadoConsolidado_OPU>(filtro);
    				return ConsultarEstadoConsolidado_OPU(expresionFiltrado, campoOrdenamiento, out totalRegistros, indicePagina, registrosPorPagina, esAscendente);
    		}
          ...
          /// </summary>
        	...
        	/// <param name="esAscendente">Indica si es ascendente el ordenamiento</param>
        	/// <returns></returns>
    		public IEnumerable<EstadoConsolidado_OPU> ConsultarEstadoConsolidado_OPU(IDictionary<string, string> filtros, Dictionary<LambdaExpression, OperadorLogico> where, string campoOrdenamiento, out int totalRegistros, int indicePagina = 0, int registrosPorPagina = 20, bool esAscendente = true)
    		{
    				Expression<Func<EstadoConsolidado_OPU, bool>> expresionFiltrado = ObtenerFiltro<EstadoConsolidado_OPU>(filtros,where);
    				return ConsultarEstadoConsolidado_OPU(expresionFiltrado, campoOrdenamiento, out totalRegistros, indicePagina, registrosPorPagina, esAscendente);
    		}
          ...
          /// </summary>
        	...
        	/// <param name="esAscendente">Indica si es ascendente el ordenamiento</param>
        	/// <returns></returns>
    		public IEnumerable<EstadoConsolidado_OPU> ConsultarEstadoConsolidado_OPU(Expression<Func<EstadoConsolidado_OPU, bool>> expresionFiltrado, string campoOrdenamiento, out int totalRegistros, int indicePagina = 0, int registrosPorPagina = 20, bool esAscendente = true)
    		{
    			...
    			var objectSet = ((IObjectContextAdapter)this).ObjectContext.CreateObjectSet<EstadoConsolidado_OPU>();
    		...
    		/// <summary>
          /// Retorna la lista de EstadoConsolidado_OPU que cumpla con la expresión de ordenamiento
          /// </summary>
        	/// <param name="campoOrdenamiento">Campo por el cual se va a realizar el ordenamiento</param>
        	...
        	/// <param name="esAscendente">Indica si es ascendente el ordenamiento</param>
        	/// <returns></returns>
    		public IEnumerable<EstadoConsolidado_OPU> ConsultarEstadoConsolidado_OPU(string campoOrdenamiento, out int totalRegistros, int indicePagina = 0, int registrosPorPagina = 20, bool esAscendente = true)
    		{
    			// Verificando parámetros para la consulta
    			if (indicePagina < 0)
    		...
    		#region Propiedades
        public DbSet<EstadoConsolidado_OPU> EstadoConsolidado_OPU { get; set; }
    
        public virtual int paGrabarEstadoConsolidado_OPU(Nullable<long> eCO_IdInvContenedor, string eCO_Estado, string eCO_Observaciones, Nullable<long> eCO_IdCentroServicios, string eCO_CreadoPor)
        {
            var eCO_IdInvContenedorParameter = eCO_IdInvContenedor.HasValue ?
                new ObjectParameter("ECO_IdInvContenedor", eCO_IdInvContenedor) :
                new ObjectParameter("ECO_IdInvContenedor", typeof(long));
    
            var eCO_EstadoParameter = eCO_Estado != null ?
                new ObjectParameter("ECO_Estado", eCO_Estado) :
                new ObjectParameter("ECO_Estado", typeof(string));
    
            var eCO_ObservacionesParameter = eCO_Observaciones != null ?
                new ObjectParameter("ECO_Observaciones", eCO_Observaciones) :
                new ObjectParameter("ECO_Observaciones", typeof(string));
    
            var eCO_IdCentroServiciosParameter = eCO_IdCentroServicios.HasValue ?
                new ObjectParameter("ECO_IdCentroServicios", eCO_IdCentroServicios) :
                new ObjectParameter("ECO_IdCentroServicios", typeof(long));
    
            var eCO_CreadoPorParameter = eCO_CreadoPor != null ?
                new ObjectParameter("ECO_CreadoPor", eCO_CreadoPor) :
                new ObjectParameter("ECO_CreadoPor", typeof(string));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("paGrabarEstadoConsolidado_OPU", eCO_IdInvContenedorParameter, eCO_EstadoParameter, eCO_ObservacionesParameter, eCO_IdCentroServiciosParameter, eCO_CreadoPorParameter);
        }
    
        public virtual ObjectResult<paObtenerInventarioPorCodigoInventario_OPU_Result> paObtenerInventarioPorCodigoInventario_OPU(string iNT_Codigo)
        {
            ((IObjectContextAdapter)this).ObjectContext.MetadataWorkspace.LoadFromAssembly(typeof(paObtenerInventarioPorCodigoInventario_OPU_Result).Assembly);
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<paObtenerInventarioPorCodigoInventario_OPU_Result>("paObtenerInventarioPorCodigoInventario_OPU", iNT_CodigoParameter);
        }
    	#endregion
    }
		/// <summary>
