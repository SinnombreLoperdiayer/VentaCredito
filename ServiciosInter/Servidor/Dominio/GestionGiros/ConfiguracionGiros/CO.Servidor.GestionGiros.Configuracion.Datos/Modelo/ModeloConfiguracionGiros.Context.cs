...
namespace CO.Servidor.GestionGiros.Configuracion.Datos.Modelo
{
    ...
    public partial class ModeloConfiguracionGiros : DbContext
    {
        public ModeloConfiguracionGiros(string ConnectionString)
    	...
    	/// <summary>
          ...
          /// </summary>
    		...
    		/// <summary>
    		/// Retorna la lista de MotivoInactivacionGiros_GIR que cumpla con las expresiones de filtrado y ordenamiento
          /// </summary>
    		/// <param name="filtro">Diccionario a través del cual se filtra la lista</param>
        	/// <param name="campoOrdenamiento">Campo por el cual se va a realizar el ordenamiento</param>
    		/// <param name="totalRegistros">Retorna el total de de registros que satisfacen la consulta sin paginar</param>
        	...
        	/// <param name="esAscendente">Indica si es ascendente el ordenamiento</param>
        	/// <returns></returns>
    			public IEnumerable<MotivoInactivacionGiros_GIR> ConsultarContainsMotivoInactivacionGiros_GIR(IDictionary<string, string> filtro, string campoOrdenamiento, out int totalRegistros, int indicePagina = 0, int registrosPorPagina = 20, bool esAscendente = true)
    		{
    			Expression<Func<MotivoInactivacionGiros_GIR, bool>> expresionFiltrado = ObtenerExpresionContains<MotivoInactivacionGiros_GIR>(filtro);
    			return ConsultarMotivoInactivacionGiros_GIR(expresionFiltrado, campoOrdenamiento, out totalRegistros, indicePagina, registrosPorPagina, esAscendente);
    		}
          ...
          /// </summary>
        	...
        	/// <param name="esAscendente">Indica si es ascendente el ordenamiento</param>
        	/// <returns></returns>
    		public IEnumerable<MotivoInactivacionGiros_GIR> ConsultarEqualsMotivoInactivacionGiros_GIR(IDictionary<string, string> filtro, string campoOrdenamiento, out int totalRegistros, int indicePagina = 0, int registrosPorPagina = 20, bool esAscendente = true)
    		{
    				Expression<Func<MotivoInactivacionGiros_GIR, bool>> expresionFiltrado = ObtenerExpresionEquals<MotivoInactivacionGiros_GIR>(filtro);
    				return ConsultarMotivoInactivacionGiros_GIR(expresionFiltrado, campoOrdenamiento, out totalRegistros, indicePagina, registrosPorPagina, esAscendente);
    		}
          ...
          /// </summary>
        	...
        	/// <param name="esAscendente">Indica si es ascendente el ordenamiento</param>
        	/// <returns></returns>
    		public IEnumerable<MotivoInactivacionGiros_GIR> ConsultarMotivoInactivacionGiros_GIR(IDictionary<string, string> filtros, Dictionary<LambdaExpression, OperadorLogico> where, string campoOrdenamiento, out int totalRegistros, int indicePagina = 0, int registrosPorPagina = 20, bool esAscendente = true)
    		{
    				Expression<Func<MotivoInactivacionGiros_GIR, bool>> expresionFiltrado = ObtenerFiltro<MotivoInactivacionGiros_GIR>(filtros,where);
    				return ConsultarMotivoInactivacionGiros_GIR(expresionFiltrado, campoOrdenamiento, out totalRegistros, indicePagina, registrosPorPagina, esAscendente);
    		}
          ...
          /// </summary>
        	...
        	/// <param name="esAscendente">Indica si es ascendente el ordenamiento</param>
        	/// <returns></returns>
    		public IEnumerable<MotivoInactivacionGiros_GIR> ConsultarMotivoInactivacionGiros_GIR(Expression<Func<MotivoInactivacionGiros_GIR, bool>> expresionFiltrado, string campoOrdenamiento, out int totalRegistros, int indicePagina = 0, int registrosPorPagina = 20, bool esAscendente = true)
    		{
    			// Verificando parámetros para la consulta
    			if (indicePagina < 0)
    				throw new ArgumentException("Número de Página inválida");
    			...
    			//Create associated IObjectSet and perform query			
    			var objectSet = ((IObjectContextAdapter)this).ObjectContext.CreateObjectSet<MotivoInactivacionGiros_GIR>();
    		...
    		/// <summary>
          /// Retorna la lista de MotivoInactivacionGiros_GIR que cumpla con la expresión de ordenamiento
          /// </summary>
        	/// <param name="campoOrdenamiento">Campo por el cual se va a realizar el ordenamiento</param>
    		/// <param name="totalRegistros">Retorna el total de registros que genera la consulta sin paginar</param>
        	/// <param name="indicePagina">Índice de página a retornar</param>
        	...
        	/// <param name="esAscendente">Indica si es ascendente el ordenamiento</param>
        	/// <returns></returns>
    		public IEnumerable<MotivoInactivacionGiros_GIR> ConsultarMotivoInactivacionGiros_GIR(string campoOrdenamiento, out int totalRegistros, int indicePagina = 0, int registrosPorPagina = 20, bool esAscendente = true)
    		{
    			// Verificando parámetros para la consulta
    			if (indicePagina < 0)
    				throw new ArgumentException("Página inválida");
        ...
        public DbSet<MotivoInactivacionGiros_GIR> MotivoInactivacionGiros_GIR { get; set; }
    	#endregion
    }
		/// <summary>
