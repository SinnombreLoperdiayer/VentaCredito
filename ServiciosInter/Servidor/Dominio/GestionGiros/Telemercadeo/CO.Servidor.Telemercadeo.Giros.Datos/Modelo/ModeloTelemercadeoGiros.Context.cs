...
namespace CO.Servidor.Telemercadeo.Giros.Datos.Modelo
{
    ...
    public partial class ModeloTelemercadeoGiros : DbContext
    {
        public ModeloTelemercadeoGiros(string ConnectionString)
        ...
        public virtual int paActualizarTelemercadeoAdmGiro_GIR(Nullable<long> numeroGiro)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("paActualizarTelemercadeoAdmGiro_GIR", numeroGiroParameter);
        }
    
        public virtual ObjectResult<GIpaObtenerGirosTelemercadeo> paObtenerGirosTelemercadeo_GIR(Nullable<long> numeroGiro, Nullable<System.DateTime> fechaInicial, Nullable<System.DateTime> fechaFinal, Nullable<int> pageIndex, Nullable<int> pageSize, Nullable<long> idRacol, Nullable<long> idCentroServicio)
        {
            ((IObjectContextAdapter)this).ObjectContext.MetadataWorkspace.LoadFromAssembly(typeof(GIpaObtenerGirosTelemercadeo).Assembly);
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<GIpaObtenerGirosTelemercadeo>("paObtenerGirosTelemercadeo_GIR", numeroGiroParameter, fechaInicialParameter, fechaFinalParameter, pageIndexParameter, pageSizeParameter, idRacolParameter, idCentroServicioParameter);
        }
    	#endregion
    }
		/// <summary>
