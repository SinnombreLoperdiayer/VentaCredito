...
{
    public class ReglaMapeoNombreCentroServicioDestino : IEstadoRAPS
    {
        /// <summary>
        ///  Agrega parametrizacion NombreCentroServicioDestino
        /// </summary>
        ...
        public void EjecutarReglaParametros(OUGuiaIngresadaDC guia, int IdParametroAsociado, ref Dictionary<string, object> parametrosParametrizacion)
        {
          ...
          //  parametrosParametrizacion = new Dictionary<string, object>();
            ...
            parametrosParametrizacion.Add(IdParametroAsociado.ToString(), guia.NombreCentroServicioDestino);
