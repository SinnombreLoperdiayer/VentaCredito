...
namespace CO.Servidor.LogisticaInversa.Reglas.Modelo
{
    ...
    public partial class EntidadesReglasLogisticaInversa : DbContext
    {
        public EntidadesReglasLogisticaInversa(string ConnectionString)
        ...
        private Expression<Func<TLinqEntity, bool>> ArmarExpresionFiltrado<TLinqEntity>(IDictionary<string, string> filtros, string tipoFiltro)
        {
          ...
          return null;
    		    ...
    		    #region Consultas
    	/// <summary>
    		/// Retorna la lista de GestionGuiaTelemercadeo_LOI que cumpla con las expresiones de filtrado y ordenamiento
          /// </summary>
        	...
        	/// <returns></returns>
    			public IEnumerable<GestionGuiaTelemercadeo_LOI> ConsultarContainsGestionGuiaTelemercadeo_LOI(IDictionary<string, string> filtro, string campoOrdenamiento, out int totalRegistros, int indicePagina = 0, int registrosPorPagina = 20, bool esAscendente = true)
    		{
    			Expression<Func<GestionGuiaTelemercadeo_LOI, bool>> expresionFiltrado = ObtenerExpresionContains<GestionGuiaTelemercadeo_LOI>(filtro);
    			return ConsultarGestionGuiaTelemercadeo_LOI(expresionFiltrado, campoOrdenamiento, out totalRegistros, indicePagina, registrosPorPagina, esAscendente);
    		}
          ...
          /// </summary>
        	...
        	/// <param name="esAscendente">Indica si es ascendente el ordenamiento</param>
        	/// <returns></returns>
    		public IEnumerable<GestionGuiaTelemercadeo_LOI> ConsultarEqualsGestionGuiaTelemercadeo_LOI(IDictionary<string, string> filtro, string campoOrdenamiento, out int totalRegistros, int indicePagina = 0, int registrosPorPagina = 20, bool esAscendente = true)
    		{
    				Expression<Func<GestionGuiaTelemercadeo_LOI, bool>> expresionFiltrado = ObtenerExpresionEquals<GestionGuiaTelemercadeo_LOI>(filtro);
    				return ConsultarGestionGuiaTelemercadeo_LOI(expresionFiltrado, campoOrdenamiento, out totalRegistros, indicePagina, registrosPorPagina, esAscendente);
    		}
          ...
          /// </summary>
        	...
        	/// <param name="esAscendente">Indica si es ascendente el ordenamiento</param>
        	/// <returns></returns>
    		public IEnumerable<GestionGuiaTelemercadeo_LOI> ConsultarGestionGuiaTelemercadeo_LOI(IDictionary<string, string> filtros, Dictionary<LambdaExpression, OperadorLogico> where, string campoOrdenamiento, out int totalRegistros, int indicePagina = 0, int registrosPorPagina = 20, bool esAscendente = true)
    		{
    				Expression<Func<GestionGuiaTelemercadeo_LOI, bool>> expresionFiltrado = ObtenerFiltro<GestionGuiaTelemercadeo_LOI>(filtros,where);
    				return ConsultarGestionGuiaTelemercadeo_LOI(expresionFiltrado, campoOrdenamiento, out totalRegistros, indicePagina, registrosPorPagina, esAscendente);
    		}
          ...
          /// </summary>
        	...
        	/// <param name="esAscendente">Indica si es ascendente el ordenamiento</param>
        	/// <returns></returns>
    		public IEnumerable<GestionGuiaTelemercadeo_LOI> ConsultarGestionGuiaTelemercadeo_LOI(Expression<Func<GestionGuiaTelemercadeo_LOI, bool>> expresionFiltrado, string campoOrdenamiento, out int totalRegistros, int indicePagina = 0, int registrosPorPagina = 20, bool esAscendente = true)
    		{
    			...
    			var objectSet = ((IObjectContextAdapter)this).ObjectContext.CreateObjectSet<GestionGuiaTelemercadeo_LOI>();
    		...
    		/// <summary>
          /// Retorna la lista de GestionGuiaTelemercadeo_LOI que cumpla con la expresión de ordenamiento
          /// </summary>
        	/// <param name="campoOrdenamiento">Campo por el cual se va a realizar el ordenamiento</param>
        	...
        	/// <param name="esAscendente">Indica si es ascendente el ordenamiento</param>
        	/// <returns></returns>
    		public IEnumerable<GestionGuiaTelemercadeo_LOI> ConsultarGestionGuiaTelemercadeo_LOI(string campoOrdenamiento, out int totalRegistros, int indicePagina = 0, int registrosPorPagina = 20, bool esAscendente = true)
    		{
    			// Verificando parámetros para la consulta
    			if (indicePagina < 0)
    		...
    		#region Propiedades
        public DbSet<GestionGuiaTelemercadeo_LOI> GestionGuiaTelemercadeo_LOI { get; set; }
    
        public virtual ObjectResult<Nullable<long>> paBuscarDireccionMensajeria_MEN(string direccion, Nullable<bool> esDestinatario, string localidad)
        {
            var direccionParameter = direccion != null ?
                new ObjectParameter("Direccion", direccion) :
                new ObjectParameter("Direccion", typeof(string));
    
            var esDestinatarioParameter = esDestinatario.HasValue ?
                new ObjectParameter("EsDestinatario", esDestinatario) :
                new ObjectParameter("EsDestinatario", typeof(bool));
    
            var localidadParameter = localidad != null ?
                new ObjectParameter("Localidad", localidad) :
                new ObjectParameter("Localidad", typeof(string));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<Nullable<long>>("paBuscarDireccionMensajeria_MEN", direccionParameter, esDestinatarioParameter, localidadParameter);
        }
    	#endregion
    }
		/// <summary>
