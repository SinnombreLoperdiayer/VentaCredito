...
{
  /// <summary>
  /// Regla para manejo de lógica de negocio para cambio de ciudad destino
  /// </summary>
  public class LOIReglaCambioCiudadDestino : IReglaNegocio
  {
    private ADTrazaGuia trazaGuia;
    ...
    public void Ejecutar(IDictionary<string, object> parametrosRegla)
    {
      ...
      if ((trazaGuia.IdNuevoEstadoGuia != (short)(ADEnumEstadoGuia.DevolucionRatificada) && trazaGuia.IdNuevoEstadoGuia != (short)(ADEnumEstadoGuia.CentroAcopio)))
      {
