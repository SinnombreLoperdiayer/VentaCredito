...
{
  /// <summary>
  /// Regla para manejo de lógica de negocio para direccion actualizada
  /// </summary>
  public class LOIReglaDireccionActualizada : IReglaNegocio
  {
    ...
    public void Ejecutar(IDictionary<string, object> parametrosRegla)
    {
      ...
      if ((trazaGuia.IdNuevoEstadoGuia != (short)(ADEnumEstadoGuia.CentroAcopio)))
      {
