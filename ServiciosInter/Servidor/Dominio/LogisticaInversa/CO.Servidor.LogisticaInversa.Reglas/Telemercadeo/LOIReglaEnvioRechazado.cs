...
{
  /// <summary>
  /// Regla para manejo de lógica de negocio para envio rechazado
  /// </summary>
  public class LOIReglaEnvioRechazado : IReglaNegocio
  {
    ...
    public void Ejecutar(IDictionary<string, object> parametrosRegla)
    {
      ...
      if (!(trazaGuia.IdNuevoEstadoGuia == (short)(ADEnumEstadoGuia.DevolucionRatificada) || (trazaGuia.IdEstadoGuia == (short)(ADEnumEstadoGuia.Custodia))))
      {
