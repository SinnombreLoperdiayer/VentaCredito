...
{
  /// <summary>
  /// Regla para manejo de lógica de negocio para titular no corresponde en Telemercadeo
  /// </summary>
  public class LOIReglaTitularNoCorresponde : IReglaNegocio
  {
    ...
    public void Ejecutar(IDictionary<string, object> parametrosRegla)
    {
      ...
      if ((trazaGuia.IdNuevoEstadoGuia != (short)(ADEnumEstadoGuia.DevolucionRatificada) && trazaGuia.IdNuevoEstadoGuia != (short)(ADEnumEstadoGuia.Custodia)))
      {
