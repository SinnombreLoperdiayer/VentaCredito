...
{
    public class ReglaActualizacionAdmisionMensajeria : IReglasCambioEstado
    {
        public void EjecucionRegla(ReversionEstado reversionEstado)
        {
            ADReversionEstadosRepositorio.Instancia.ActualizacionAdmisionMensajeria(reversionEstado);
        }
    }
}
