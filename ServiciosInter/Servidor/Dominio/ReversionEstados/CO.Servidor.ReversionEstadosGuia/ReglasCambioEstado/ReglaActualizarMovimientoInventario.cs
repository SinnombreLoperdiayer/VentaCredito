...
{
    public class ReglaActualizarMovimientoInventario : IReglasCambioEstado
    {
        public void EjecucionRegla(ReversionEstado reversionEstado)
        {
            ADReversionEstadosRepositorio.Instancia.ActualizarMovimientoInventario(reversionEstado);
        }
    }
}
