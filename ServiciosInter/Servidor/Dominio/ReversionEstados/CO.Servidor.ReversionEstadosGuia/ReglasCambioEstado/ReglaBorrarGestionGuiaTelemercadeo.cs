...
{
    public class ReglaBorrarGestionGuiaTelemercadeo : IReglasCambioEstado
    {
        public void EjecucionRegla(ReversionEstado reversionEstado)
        {
            ADReversionEstadosRepositorio.Instancia.EliminarGestionGuiaTelemercadeo(reversionEstado);
        }
    }
}
