...
{
    public class ReglaBorrarPlanillaAsignacionGuia : IReglasCambioEstado
    {
        public void EjecucionRegla(ReversionEstado reversionEstado)
        {
            ADReversionEstadosRepositorio.Instancia.EliminarPlanillaAsignacionGuia(reversionEstado);
        }
    }
}
