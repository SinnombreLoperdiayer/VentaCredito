...
{
  internal class TAServicioCargaExpress : TAServicio
  {
    #region Campos

    private static readonly TAServicioCargaExpress instancia = (TAServicioCargaExpress)FabricaInterceptores.GetProxy(new TAServicioCargaExpress(), COConstantesModulos.TARIFAS);

    private int idServicio = TAConstantesServicios.SERVICIO_CARGA_EXPRESS;
    ...
    {
      TAPrecioMensajeriaDC valorPeso = TARepositorio.Instancia.ObtenerPrecioMensajeria(TAConstantesServicios.SERVICIO_CARGA_EXPRESS, idListaPrecio, idLocalidadOrigen, idLocalidadDestino, peso, valorDeclarado, esPrimeraAdmision,idTipoEntrega);
