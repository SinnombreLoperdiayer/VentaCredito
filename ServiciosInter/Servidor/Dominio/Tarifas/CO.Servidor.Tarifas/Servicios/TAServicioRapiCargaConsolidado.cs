...
{
  internal class TAServicioRapiCargaConsolidado : TAServicio
  {
    #region Campos

    private static readonly TAServicioRapiCargaConsolidado instancia = (TAServicioRapiCargaConsolidado)FabricaInterceptores.GetProxy(new TAServicioRapiCargaConsolidado(), COConstantesModulos.TARIFAS);

    private int idServicio = TAConstantesServicios.SERVICIO_RAPI_CARGA_CONSOLIDADA;

    #endregion Campos

    #region Propiedades

    public static TAServicioRapiCargaConsolidado Instancia
    {
