...
{
  internal class TAServicioRapiRadicado : TAServicio
  {
    #region Campos

    private static readonly TAServicioRapiRadicado instancia = (TAServicioRapiRadicado)FabricaInterceptores.GetProxy(new TAServicioRapiRadicado(), COConstantesModulos.TARIFAS);
    ...
    public static TAServicioRapiRadicado Instancia
    {
