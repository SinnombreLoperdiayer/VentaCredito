...
{
  internal class TAServicioRapiValijas : TAServicio
  {
    #region Campos

    private static readonly TAServicioRapiValijas instancia = (TAServicioRapiValijas)FabricaInterceptores.GetProxy(new TAServicioRapiValijas(), COConstantesModulos.TARIFAS);

    private int idServicio = TAConstantesServicios.SERVICIO_RAPI_VALIJAS;

    #endregion Campos

    #region Propiedades

    public static TAServicioRapiValijas Instancia
    {
