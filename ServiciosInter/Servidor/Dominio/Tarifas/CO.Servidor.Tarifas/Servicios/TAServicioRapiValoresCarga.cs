...
{
  internal class TAServicioRapiValoresCarga : TAServicio
  {
    #region Campos

    private static readonly TAServicioRapiValoresCarga instancia = (TAServicioRapiValoresCarga)FabricaInterceptores.GetProxy(new TAServicioRapiValoresCarga(), COConstantesModulos.TARIFAS);

    private int idServicio = TAConstantesServicios.SERVICIO_RAPI_VALORES_CARGA;

    #endregion Campos

    #region Propiedades

    public static TAServicioRapiValoresCarga Instancia
    {
