...
{
  internal class TAServicioRapiValoresMsj : TAServicio
  {
    #region Campos

    private static readonly TAServicioRapiValoresMsj instancia = (TAServicioRapiValoresMsj)FabricaInterceptores.GetProxy(new TAServicioRapiValoresMsj(), COConstantesModulos.TARIFAS);

    private int idServicio = TAConstantesServicios.SERVICIO_RAPI_VALORES_MENSAJERIA;

    #endregion Campos

    #region Propiedades

    public static TAServicioRapiValoresMsj Instancia
    {
