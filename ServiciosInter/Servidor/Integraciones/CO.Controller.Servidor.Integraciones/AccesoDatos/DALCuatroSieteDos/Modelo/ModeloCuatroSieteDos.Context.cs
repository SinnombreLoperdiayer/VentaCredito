...
namespace CO.Controller.Servidor.Integraciones.AccesoDatos.DALCuatroSieteDos.Modelo
{
    ...
    public partial class ModeloCuatroSieteDos : DbContext
    {
        public ModeloCuatroSieteDos(string ConnectionString)
        ...
        private Expression<Func<TLinqEntity, bool>> ArmarExpresionFiltrado<TLinqEntity>(IDictionary<string, string> filtros, string tipoFiltro)
        {
          ...
          return null;
    		    ...
    		    #region Consultas
    	/// <summary>
    		/// Retorna la lista de TransaccionesAliados472 que cumpla con las expresiones de filtrado y ordenamiento
          /// </summary>
        	...
        	/// <returns></returns>
    			public IEnumerable<TransaccionesAliados472> ConsultarContainsTransaccionesAliados472(IDictionary<string, string> filtro, string campoOrdenamiento, out int totalRegistros, int indicePagina = 0, int registrosPorPagina = 20, bool esAscendente = true)
    		{
    			Expression<Func<TransaccionesAliados472, bool>> expresionFiltrado = ObtenerExpresionContains<TransaccionesAliados472>(filtro);
    			return ConsultarTransaccionesAliados472(expresionFiltrado, campoOrdenamiento, out totalRegistros, indicePagina, registrosPorPagina, esAscendente);
    		}
          ...
          /// </summary>
        	...
        	/// <param name="esAscendente">Indica si es ascendente el ordenamiento</param>
        	/// <returns></returns>
    		public IEnumerable<TransaccionesAliados472> ConsultarEqualsTransaccionesAliados472(IDictionary<string, string> filtro, string campoOrdenamiento, out int totalRegistros, int indicePagina = 0, int registrosPorPagina = 20, bool esAscendente = true)
    		{
    				Expression<Func<TransaccionesAliados472, bool>> expresionFiltrado = ObtenerExpresionEquals<TransaccionesAliados472>(filtro);
    				return ConsultarTransaccionesAliados472(expresionFiltrado, campoOrdenamiento, out totalRegistros, indicePagina, registrosPorPagina, esAscendente);
    		}
          ...
          /// </summary>
        	...
        	/// <param name="esAscendente">Indica si es ascendente el ordenamiento</param>
        	/// <returns></returns>
    		public IEnumerable<TransaccionesAliados472> ConsultarTransaccionesAliados472(IDictionary<string, string> filtros, Dictionary<LambdaExpression, OperadorLogico> where, string campoOrdenamiento, out int totalRegistros, int indicePagina = 0, int registrosPorPagina = 20, bool esAscendente = true)
    		{
    				Expression<Func<TransaccionesAliados472, bool>> expresionFiltrado = ObtenerFiltro<TransaccionesAliados472>(filtros,where);
    				return ConsultarTransaccionesAliados472(expresionFiltrado, campoOrdenamiento, out totalRegistros, indicePagina, registrosPorPagina, esAscendente);
    		}
          ...
          /// </summary>
        	...
        	/// <param name="esAscendente">Indica si es ascendente el ordenamiento</param>
        	/// <returns></returns>
    		public IEnumerable<TransaccionesAliados472> ConsultarTransaccionesAliados472(Expression<Func<TransaccionesAliados472, bool>> expresionFiltrado, string campoOrdenamiento, out int totalRegistros, int indicePagina = 0, int registrosPorPagina = 20, bool esAscendente = true)
    		{
    			...
    			var objectSet = ((IObjectContextAdapter)this).ObjectContext.CreateObjectSet<TransaccionesAliados472>();
    		...
    		/// <summary>
          /// Retorna la lista de TransaccionesAliados472 que cumpla con la expresión de ordenamiento
          /// </summary>
        	/// <param name="campoOrdenamiento">Campo por el cual se va a realizar el ordenamiento</param>
        	...
        	/// <param name="esAscendente">Indica si es ascendente el ordenamiento</param>
        	/// <returns></returns>
    		public IEnumerable<TransaccionesAliados472> ConsultarTransaccionesAliados472(string campoOrdenamiento, out int totalRegistros, int indicePagina = 0, int registrosPorPagina = 20, bool esAscendente = true)
    		{
    			// Verificando parámetros para la consulta
    			if (indicePagina < 0)
    		...
    		#region Propiedades
        public DbSet<TransaccionesAliados472> TransaccionesAliados472 { get; set; }
    	#endregion
    }
		/// <summary>
