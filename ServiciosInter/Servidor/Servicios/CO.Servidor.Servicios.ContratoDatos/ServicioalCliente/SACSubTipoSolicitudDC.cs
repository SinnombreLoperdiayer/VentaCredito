...
namespace CO.Servidor.Servicios.ContratoDatos.ServicioalCliente
{
    ...
    public class SACSubTipoSolicitudDC : DataContractBase
    {
        [DataMember]
        ...
        [DataMember]
        [Required(ErrorMessageResourceType = typeof(Framework.Servidor.Servicios.ContratoDatos.Etiquetas), ErrorMessageResourceName = "CampoRequerido")]
        [Display(ResourceType = typeof(Framework.Servidor.Servicios.ContratoDatos.Etiquetas), Name = "SubTipo", Description = "SubTipo")]
        public short IdSubtipo { get; set; }
