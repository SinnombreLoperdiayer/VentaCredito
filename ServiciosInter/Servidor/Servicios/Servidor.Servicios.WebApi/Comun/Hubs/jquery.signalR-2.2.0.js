    ...
    signalR.fn = signalR.prototype = {
        ...
        start: function (options, callback) {
            ...
            if (!parser.protocol || parser.protocol === ":") {
                ...
                //connection.host = connection.url;
            } else {
            ...
            var url = connection.url + "/negotiate",
                onFailed = function (error, connection,a) {
                    
                    var err = signalR._.error(resources.errorOnNegotiate+"------------------"+a, error, connection._.negotiateRequest);
